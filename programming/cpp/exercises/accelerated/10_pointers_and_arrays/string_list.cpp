...
class StringList {
  public:
    ...
    StringListIterator begin() {
      return StringListIterator(head_.next_);
    }
    StringListIterator end() {
      return StringListIterator(&tail_);
    }
...
int main() {
  ...
  for (StringListIterator it = string_list.begin();
      it != string_list.end(); ++it) {
    std::cout << *it << "\n";
  }

  std::cout << "\nIn reverse order:\n";
  for (StringListIterator it = string_list.end();
