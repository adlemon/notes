...
find_url_begin(const std::string::const_iterator &begin,
               const std::string::const_iterator &end);
std::string::const_iterator
find_url_end(const std::string::const_iterator &begin,
             const std::string::const_iterator &end);
...
bool is_url_char(char c) {
  ...
  return isalnum(c) ||
         std::find(url_chars.begin(), url_chars.end(), c) != url_chars.end();
}
