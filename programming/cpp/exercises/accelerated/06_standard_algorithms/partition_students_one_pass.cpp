...
std::vector<StudentInfo>
extract_failing_students(std::vector<StudentInfo> &students) {
  std::vector<StudentInfo>::iterator failing_students_begin =
      std::stable_partition(students.begin(), students.end(), is_passing);

  std::vector<StudentInfo> failing_students(failing_students_begin,
                                            students.end());

  students.erase(failing_students_begin, students.end());
