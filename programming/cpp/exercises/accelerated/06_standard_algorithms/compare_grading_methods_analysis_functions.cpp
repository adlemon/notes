...
double median_course_grade(const std::vector<StudentData> &students,
                           double course_grade(const StudentData &student));
void write_analysis(std::ostream &out, std::string analysis_name,
                    double course_grade(const StudentData &student),
...
int main() {
  ...
  std::cout << '\n';
  write_analysis(std::cout, "median", course_grade_homework_median,
                 students_all_hw, students_missing_hw);

  write_analysis(std::cout, "mean", course_grade_homework_mean, students_all_hw,
                 students_missing_hw);

  write_analysis(std::cout, "median_nonzero",
                 course_grade_homework_median_nonzero, students_all_hw,
                 students_missing_hw);
}
...
double median_nonzero(std::vector<double> v) {
  std::vector<double>::iterator end_nonzero =
...
double median_course_grade(const std::vector<StudentData> &students,
  ...
  std::transform(students.begin(), students.end(),
                 std::back_inserter(course_grades), course_grade);
